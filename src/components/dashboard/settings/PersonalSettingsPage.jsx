...
function PasswordRequiredModal({ open, onClose, onConfirm }) {
  ...
  return (
    <div
      className="fixed inset-0 z-50 flex items-center justify-center bg-black/20 backdrop-blur-[4px] px-4"
      onClick={(e) => {
        if (e.target === e.currentTarget) onClose();
      }}
    >
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm mx-4 p-6 sm:p-8 flex flex-col gap-5">
...
function Section({ title, subtitle, children }) {
  return (
    <div className="flex flex-col gap-4 border px-4 sm:px-6 py-4 sm:py-6 border-[#ECF0F5] rounded-md">
      <div>
...
export default function PersonalSettingsPage() {
  ...
  return (
    <>
      <TopbarSlot>
        <div className="ml-auto w-full max-w-xs sm:w-72 h-9 flex items-center gap-2 px-3 rounded-lg border border-[#EBEAFD] bg-white mr-2">
        ...
        <div className="w-full max-w-xl flex flex-col gap-6">
          ...
          >
            <div
              ...
              className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 cursor-pointer w-full sm:w-fit"
            >
              <div className="w-16 h-16 rounded-full border-2 border-dashed border-[#4A24AB] flex items-center justify-center overflow-hidden bg-purple-50 hover:bg-purple-100 transition-colors shrink-0">
                {avatarSrc ? (
                  ...
                  <Upload size={18} className="text-[#4A24AB]" strokeWidth={1.5} />
                )}
              </div>
              <div>
          ...
          >
            ...
            <Button
              ...
              className="h-9 w-full sm:w-fit px-5 bg-[#4A24AB] hover:bg-[#3b1d8a] text-white text-sm font-semibold rounded-md"
            >
              Update Profile
            </Button>
          </Section>
          ...
          {/* Danger Zone */}
          <div className="rounded-lg border border-red-200 bg-red-50 p-4 sm:p-5 flex flex-col gap-3">
            <div>
            ...
            <div>
              ...
              <Button
                ...
                className="w-full sm:w-fit h-9 px-5 bg-red-600 hover:bg-red-700 text-white text-sm font-semibold rounded-md"
              >
                Delete your Account
              </Button>
            </div>
