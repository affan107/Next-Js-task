    ...
    <div className="min-h-screen flex items-center justify-center bg-[#ECEEF8]">
      <div className="w-full max-w-sm px-4">
        ...
        <Card className="p-32px gap-32px rounded-2xl shadow-sm border-0">
          ...
          <CardContent className="w-304px h-364px px-6 pb-6">
            <form className="space-y-4">
              {/* Email */}
              <div className="w-304px h-66px space-y-1.5">
                <Label
                  htmlFor="email"
                  className="w-36px h-20px text-sm font-medium text-[#4A24AB]"
                >
                  Email
                </Label>
                <Input
                  ...
                  type="email"
                  placeholder="Email"
                  className="h-10 border-#CBD5E1 placeholder:text-gray-400 focus-visible:ring-[#4A24AB]"
                  required
                />
              </div>
              ...
              <div className="w-304px h-66px space-y-1.5">
                ...
                <Input
                  ...
                  className="h-10 rounded-lg border-gray-200 placeholder:text-gray-400 focus-visible:ring-[#4A24AB]"
                  required
                />
              </div>
              <div>
              ...
              <Button
                type="submit"
                className="w-full h-10 bg-[#4A24AB] text-white rounded-lg font-medium mt-2"
              >
                Sign in with Email
              </Button>
